dataset = NFL
begin description
Medidas de desempeño de los equipos de la NFL en 1976
Fuente: Tabla B.1 del libro de Montgomery: Introducción al análisis
de Regresion Lineal, 3a. ed.
end description
begin variables
Col 0 = JG = Juegos ganados (por temporada de 14 juegos
Col 1 = yt = yardas por tierra (temporada)
Col 2 = ya = yardas por aire (temporada)
Col 3 = prompat = promedio de pateo (yardas/patada)
Col 4 = GCpor = porcentaje de goles de campo
Col 5 = rpb =razon de perdidas de balon (p'erdidas ganadas/p'erdidas perdidas)
Col 6 = ycas =yardas de castigo
Col 7 = carrepor =porcentaje de carreras (jugadas por tierra / jugadas totales)
Col 8 = ytcon =yardas por tierra del contrario
Col 9 = yacon =yardas por aire del contrario
end variables
begin data
(
