dataset = Gasolina
begin description
Datos del rendimiento de gasolina para 32 autos.
end description. Fuente: Montgomery.
begin variables
Col 0 = y = Rendimiento (millas por galon)
Col 1 = x1 = Cilindrada en pulgadas cubicas
Col 2 = x2 = Potencia (hp)
Col 3 = x3 = par de torsion (pies/lb)
Col 4 = x4 = Relacion de compresion
Col 5 = x5 = Relacion del eje trasero
Col 6 = x6 = Carburador (gargantas)
Col 7 = x7 = Numero de velocidades en la transmision
Col 8 = x8 = longitud total (pulgadas)
Col 9 = x9 = Ancho (pulgadas)
Col 10 = x10 = Peso (lbs)
Col 11 = x11 = Tipo de transmision (1=automatica, 2= manual)
end variables
begin data
(
...
16.59   400 185 0    7.6 3.08    4   3   196 73  3850    1
31.9    96.9    75  83  9   4.3 2   5   165.2   61.8    2275    0
29.4    140 86  0    8   2.92    2   4   176.4   65.4    2150    0
